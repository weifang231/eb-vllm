...
| LongBench | 15.77 | 16.31 (+3.4%) | 15.81 | 15.78 (-0.2%) | +0.3% | -3.2% | ⚠️ 噪声级 |
| WildChat | 20.87 | 19.03 (-8.8%) | 21.50 | 21.98 (+2.2%) | +3.0% | +15.5% | ⚠️ v1 偏低 |
| NumimaMath | 1.99 | 1.95 (-2.0%) | 1.94 | 1.96 (+1.0%) | -2.5% | +0.5% | ✅ |
| **Avg EB-v1** | | | | | **+0.8%** | **+3.7%** | ✅ |

**Headline**: 30B-A3B paper EB-v1 avg **-6.1% → -3.2%**（改善 2.9pp，关键是 SG 从 -12% 救到 -2.5%）。8B paper EB-v1 avg **+0.8% → +3.7%**。
...
| Prefill-heavy | (18432, 256) | 28.2 | 28.16 | 28.5 | 27.14 | +1.1% | -3.6% | ⚠️ |
...
- **Table 3 8B 4/4** — 平均 EB-v1 paper +0.8% → ours +3.7%
